...
let ForgetPasswordComponent = class ForgetPasswordComponent {
    ...
    constructor(route, router, capCharService) {
        this.route = route;
        this.router = router;
    ...
    */
    setAlertState(blank, infoValid, capChaValid) {
...
let MainheaderComponent = class MainheaderComponent {
    constructor(loginService, avatarService, notifyService) {
...
let MainpageComponent = class MainpageComponent {
    constructor(starService, loginService) {
...
let ResetPasswordComponent = class ResetPasswordComponent {
    ...
    */
    setAlertState(blank, passNotMatch, codeNotMatch) {
...
let StarProfileComponent = class StarProfileComponent {
    constructor(starprofileService) {
...
StarProfileComponent.ctorParameters = () => [
...
let CapchaService = class CapchaService {
    constructor() { }
    getCapcha() {
...
let StarProfileService = class StarProfileService {
    constructor() { }
    getStarProfile() {
